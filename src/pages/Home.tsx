...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans">
      <Helmet>
        <title>Sri Rent A Bike - Bike Rentals in Tangalle, Sri Lanka</title>
        <meta
          name="description"
          content="Authentic Bike Rentals in Tangalle. Explore the South Coast of Sri Lanka on your own terms with our reliable scooters and motorbikes. 24/7 support and friendly service."
        />
        <link rel="canonical" href="https://www.srirentabike.com/" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://www.srirentabike.com/" />
        <meta
          name="twitter:title"
          content="SriRentABike - Authentic Bike Rentals in Tangalle"
        />
        <meta
          name="twitter:description"
          content="Explore Tangalle and the South Coast on your own terms. Scooters, motorbikes, and hassle-free transport for the perfect Sri Lankan adventure."
        />
        <meta
          name="twitter:image"
          content="https://res.cloudinary.com/dthx4fxte/image/upload/v1766273824/WhatsApp_Image_2025-12-11_at_17.56.49_d4a002b8_shfm0d.jpg"
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.srirentabike.com/" />
        <meta property="og:site_name" content="Sri Rent A Bike" />
        ...
        <link
          rel="alternate"
          hreflang="en"
          href="https://www.srirentabike.com/"
        />
          ...
          {JSON.stringify([
            {
              ...
              "@type": "WebSite",
              "@id": "https://www.srirentabike.com/#website",
              name: "Sri Rent A Bike",
              alternateName: ["SriRentABike", "srirentabike.com"],
              url: "https://www.srirentabike.com/",
              publisher: { "@id": "https://www.srirentabike.com/#business" },
              inLanguage: "en-US",
            },
            {
              "@context": "https://schema.org",
              "@type": "LocalBusiness",
              "@id": "https://www.srirentabike.com/#business",
              name: "Sri Rent A Bike",
              image:
                "https://res.cloudinary.com/dthx4fxte/image/upload/v1766273824/WhatsApp_Image_2025-12-11_at_17.56.49_d4a002b8_shfm0d.jpg",
              url: "https://www.srirentabike.com/",
              ...
              sameAs: [
                "https://www.facebook.com/p/Sri-Rent-a-Bike-61571306356006/",
                "https://www.instagram.com/sribike2024/",
              ],
            },
          ])}
        </script>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[500px] md:min-h-[700px] h-[80vh] md:h-[85vh] flex items-center">
          <div className="max-w-2xl text-left">
            ...
            <p className="text-lg md:text-2xl text-stone-100 mb-8 md:mb-10 font-light drop-shadow-md leading-relaxed max-w-xl">
              Explore Tangalle and the South Coast on your own terms. Scooters,
              motorbikes, and hassle-free transport for the perfect Sri Lankan
              adventure.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6">
              Why Choose Sri Rent A Bike?
            </h2>
            <p className="text-lg text-stone-600 max-w-2xl mx-auto leading-relaxed">
              We are a local family business in Tangalle, dedicated to helping
              you experience the real Sri Lanka. No hidden fees, just friendly
              service and reliable rides.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="group p-8 rounded-3xl bg-stone-50 hover:bg-white hover:shadow-xl transition-all duration-300 border border-transparent hover:border-stone-100">
              ...
              <p className="text-stone-600 leading-relaxed">
                We're always here when you need us. Whether it's a late-night
                pickup or roadside assistance, we've got you covered around the
                clock.
              </p>
            </div>
            <div className="group p-8 rounded-3xl bg-stone-50 hover:bg-white hover:shadow-xl transition-all duration-300 border border-transparent hover:border-stone-100">
              ...
              <p className="text-stone-600 leading-relaxed">
                Need more than a bike? We also offer reliable taxi services and
                car hire to get you comfortably to your next destination.
              </p>
            </div>
            <div className="group p-8 rounded-3xl bg-stone-50 hover:bg-white hover:shadow-xl transition-all duration-300 border border-transparent hover:border-stone-100">
              ...
              <p className="text-stone-600 leading-relaxed">
                Based in Polommaruwa, Tangalle, we know the best hidden beaches,
                temples, and food spots. Ask us for recommendations!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-stone-600">
                Real stories from travelers exploring Tangalle and beyond. See
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            {galleryImages.map((src, index) => (
              <div
                key={index}
                className="break-inside-avoid rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group"
              >
                <img
                  src={src}
      ...
      <div className="py-32 bg-stone-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-stone-300 mb-12 max-w-2xl mx-auto">
            Book your ride today. Simple, fast, and handled with care by locals
            who want you to have the best trip possible.
          </p>
          <button
            onClick={handlePublicForm}
      ...
      <footer className="bg-black text-stone-400 py-16 border-t border-stone-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-stone-500 max-w-sm mb-6">
                Sri Rent A Bike is your trusted partner for exploring Tangalle.
                We provide quality bikes, scooters, and taxi services with 24/7
                support.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li className="flex items-center">
                  ...
                  <a
                    href="mailto:srbikesrirentbike@gmail.com"
                    className="hover:text-orange-500 transition-colors"
                  >
                    srbikesrirentbike@gmail.com
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-stone-800 text-center text-xs text-stone-600">
            <p>
              &copy; {new Date().getFullYear()} Sri Rent A Bike. All rights
              reserved.
            </p>
          </div>
        </div>
