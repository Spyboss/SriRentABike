  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans">
      <Helmet>
        ...
        <meta name="twitter:title" content="SriRentABike - Authentic Bike Rentals in Tangalle" />
        <meta name="twitter:description" content="Explore Tangalle and the South Coast on your own terms. Scooters, motorbikes, and hassle-free transport for the perfect Sri Lankan adventure." />
